...
def example2():
    ...
    lindi_cloud_upload(client, "https://lindi.neurosift.org/zones/magland/test1/f/sample1.nwb.zarr.json")
...
def _create_sample_nwb_file():
    ...
    # seed the random number generator so we don't upload new chunks every time
    np.random.seed(1234)
